...
class _sub_pos: public _range, public _name, public _score{
	public:
	inline sub_pos& join();
};
class _sub_strd_pos: public _sub_pos, public _strd{
	public:
	inline _sub_strd_pos& join();
};

/*
class pos: public _sub_pos{
	public:
